 ...
 */
final class Version20201116230331 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product ADD invoice_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_D34A04AD2989F1FD ON product');
        $this->addSql('ALTER TABLE product DROP invoice_id');
    }
}
